      ...
      if (infowindow.marker != marker) {
        ...
        function getStreetView(data, status) {
          if (status == google.maps.StreetViewStatus.OK) {
            ...
            infowindow.setContent('<div>' + marker.title + '</div><div id="pano"><img src="https://maps.googleapis.com/maps/api/streetview?location=42.40404.2.17513&size=500x500&heading=200&fov=70&pitch=40&key=AIzaSyBAbm2mpHRxSmSk-iaI19oMYKFEqDLxZ_k"></div>');
            var panoramaOptions = {
